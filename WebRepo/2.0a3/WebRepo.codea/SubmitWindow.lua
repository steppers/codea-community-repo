...
local function verifyAndSubmit(submit_bttn, error_label, complete_callback)
    if submit_in_progress then return end -- abort
...
function SubmitWindow()
    ...
    :add_children(
        ...
        :add_children(
            ...
            :set_style_sheet(UI.THEME.news_internal),
            TextDropdown(10, 0, -10, 30, meta.category or "Select Category", {
            ...
            :set_style_sheet(UI.THEME.news_internal),
            Oil.TextEntry(10, 0, -10, 35, meta.authors, function(str)
                meta.authors = str
                saveMeta()
            end)
            ...
            :set_style_sheet(UI.THEME.news_internal),
            Oil.TextEntry(10, 0, -10, 35, meta.short_description, function(str)
            ...
            :set_style_sheet(UI.THEME.news_internal),
            Oil.TextEntry(10, 0, -10, 200, meta.description, function(str)
            ...
            :set_style_sheet(UI.THEME.news_internal),
            Oil.TextEntry(10, 0, -10, 35, meta.version or "1.0.0", function(str)
                meta.version = str
                saveMeta()
            end)
            :set_style_sheet(UI.THEME.text_entry),
            ...
            :set_style_sheet(UI.THEME.news_internal),
            Oil.TextEntry(10, 0, -10, 100, meta.update_notes, function(str)
            ...
            :set_style_sheet(UI.THEME.news_internal),
            Oil.TextEntry(10, 0, -10, 35, meta.forum_link or "https://codea.io/talk/", function(str)
                meta.forum_link = str
                saveMeta()
            end)
            :set_style_sheet(UI.THEME.text_entry),
