...
local style_button_light_fixed = {
    fill = color(230),
    fillButtonNormal = color(230),
    fillButtonHover = color(196),
    fillButtonPressed = color(128),
...
local style_news_dark = {
    radius = 16,
    fill = color(196),
    fillButtonNormal = color(196),
    fillButtonHover = color(196),
    fillButtonPressed = color(196)
}
...
theme_light = {
    ...
    button_fixed = style_button_light_fixed,
...
theme_dark = {
    ...
    button_fixed = style_button_dark_fixed,
