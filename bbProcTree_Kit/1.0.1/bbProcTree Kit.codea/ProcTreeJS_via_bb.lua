...
function makeTree(settings){
        var t = new Tree({
            ...
            "segments":settings[1],
            "levels":settings[2], //5
            "vMultiplier":settings[3],
            "twigScale":settings[4],
            "initalBranchLength":settings[5], //0.49
            "lengthFalloffFactor":settings[6], //0.85
            "lengthFalloffPower":settings[7],
            "clumpMax":settings[8],
            "clumpMin":settings[9],
            "branchFactor":settings[10],
            "dropAmount":settings[11],
            "growAmount":settings[12],
            "sweepAmount":settings[13],
            "maxRadius":settings[14],
            "climbRate":settings[15], //0.322
            "trunkKink":settings[16], //0
            "treeSteps":settings[17], //1
            "taperRate":settings[18],
            "radiusFalloffRate":settings[19],
            "twistRate":settings[20],
            "trunkLength":settings[21],
...
--[[
MakeStatsTree = [[
function makeStatsTree(settings){
    var t = new Tree({
        "seed":settings[0],
        "segments":settings[1],
        "levels":settings[2], //5
